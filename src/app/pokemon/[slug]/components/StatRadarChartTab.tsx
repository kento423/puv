...
export default function StatRadarChartTab({ slug }: StatRadarChartTabProps) {
  return (
    <div className="w-full space-y-4">
      <div className="bg-amber-50 dark:bg-amber-900 border border-amber-200 dark:border-amber-800 px-4 py-3 rounded-lg text-sm text-amber-800 dark:text-amber-100">
        🔄 詳細なステータス仕様は現在調整中です。Coming soon...
      </div>
