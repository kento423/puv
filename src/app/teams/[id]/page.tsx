    ...
    return (
        <div className="container mx-auto px-4 py-8 max-w-7xl">
            ...
            <div className="relative mb-10 overflow-hidden rounded-3xl bg-white dark:bg-gray-800 shadow-xl border border-gray-100 dark:border-gray-700">
                <div className="absolute top-0 left-0 w-full h-32 bg-gradient-to-r from-brand-primary to-brand-accent opacity-10 dark:opacity-20"></div>

                <div className="relative z-10 flex flex-col md:flex-row items-center gap-8 p-8 md:p-10">
                    <div className="w-32 h-32 md:w-40 md:h-40 rounded-3xl bg-white dark:bg-gray-700 flex items-center justify-center overflow-hidden border-4 border-white dark:border-gray-800 shadow-2xl transform md:-rotate-3 translate-y-2 md:translate-y-0 text-brand-primary dark:text-purple-400">
                        {team.logoUrl ? (
                    ...
                    <div className="text-center md:text-left flex-1 space-y-3">
                        <div className="flex flex-col md:flex-row items-center md:items-end gap-3 mb-1">
                            ...
                            <span className={`text-xs font-black tracking-widest px-3 py-1.5 rounded-xl border mb-1.5 ${String(team.type).toLowerCase() === 'pro'
                                ? 'bg-brand-accent text-white border-orange-400'
                        ...
                        <div className="flex items-center justify-center md:justify-start gap-2 text-gray-500 dark:text-gray-400 text-sm font-medium">
                            ...
                            {team.twitterUrl && (
                                <a href={team.twitterUrl} target="_blank" rel="noopener noreferrer" className="bg-gray-100 dark:bg-gray-700 px-3 py-1 rounded-lg hover:text-brand-primary transition-colors flex items-center gap-1">
                            ...
                            {team.websiteUrl && (
                                <a href={team.websiteUrl} target="_blank" rel="noopener noreferrer" className="bg-gray-100 dark:bg-gray-700 px-3 py-1 rounded-lg hover:text-brand-accent transition-colors flex items-center gap-1">
                        ...
                        <div className="bg-white dark:bg-gray-800 rounded-3xl p-8 border border-gray-100 dark:border-gray-700 shadow-lg">
                            <div className="flex items-center justify-between mb-8">
                                <h2 className="text-2xl font-black text-gray-900 dark:text-white flex items-center gap-3">
                                    <span className="w-2 h-8 bg-brand-primary rounded-full shadow-[0_0_15px_rgba(147,51,234,0.5)]"></span>
                                    チーム プレイスタイル分析
                                </h2>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
                                <div className="relative group">
                                    <div className="absolute inset-0 bg-brand-primary/5 dark:bg-brand-primary/10 rounded-full blur-3xl group-hover:bg-brand-primary/15 transition-all duration-700"></div>
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    {metrics.map(m => {
                                        ...
                                        return (
                                            <div key={m.id} className="group bg-gray-50 dark:bg-gray-900/50 p-4 rounded-2xl border border-gray-100 dark:border-gray-800 transition-all hover:bg-white dark:hover:bg-gray-800 hover:shadow-md hover:border-brand-primary/30">
                                                <div className="text-[10px] font-black uppercase tracking-widest text-gray-400 mb-1 group-hover:text-brand-primary transition-colors">{m.label}</div>
                                                ...
                                                <div className="mt-2 w-full h-1 bg-gray-200 dark:bg-gray-700 rounded-full overflow-hidden">
                                                    <div
                                                        className="h-full bg-gradient-to-r from-brand-primary to-orange-400 rounded-full opacity-80"
                            ...
                            <div className="flex flex-wrap gap-4">
                                {team.sponsors.map((sponsor) => (
                                    <a
                                        ...
                                        className="w-16 h-16 rounded-2xl bg-gray-50 dark:bg-gray-900 flex items-center justify-center p-2 border border-gray-100 dark:border-gray-700 hover:border-brand-accent/50 transition-all group"
                                    >
                                        {sponsor.logoUrl ? (
