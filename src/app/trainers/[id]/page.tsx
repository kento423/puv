            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
                    ...
                    <div className="bg-white dark:bg-gray-800 rounded-3xl p-8 border border-gray-100 dark:border-gray-700 shadow-lg">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                {metrics.map(m => (
                                    <div key={m.id} className="group bg-gray-50 dark:bg-gray-900/50 p-5 rounded-2xl border border-gray-100 dark:border-gray-800 transition-all hover:bg-white dark:hover:bg-gray-800 hover:shadow-md hover:border-brand-primary/30">
                ...
                <div className="lg:col-span-4 space-y-8">
                    <div className="bg-white dark:bg-gray-800 rounded-3xl p-8 border border-gray-100 dark:border-gray-700 shadow-lg sticky top-24">
                        <h3 className="text-lg font-black text-gray-900 dark:text-white mb-6 pb-2 border-b-2 border-brand-primary/20 flex items-center gap-2">
                            <span className="w-1.5 h-1.5 bg-brand-primary rounded-full"></span>
                            所属履歴
                        </h3>
                        <ul className="space-y-6 relative before:absolute before:inset-y-0 before:left-3 before:w-0.5 before:bg-gradient-to-b before:from-brand-primary/20 before:to-transparent">
                            {trainer.history.length > 0 ? (
                                trainer.history.map((h) => (
                                    <li key={h.id} className="relative pl-8">
                                        <div className="absolute left-1.5 top-1.5 w-3 h-3 bg-white dark:bg-gray-800 border-2 border-brand-primary rounded-full z-10"></div>
                                        <div className="bg-gray-50 dark:bg-gray-900/50 p-4 rounded-xl border border-transparent hover:border-brand-primary/20 transition-all">
